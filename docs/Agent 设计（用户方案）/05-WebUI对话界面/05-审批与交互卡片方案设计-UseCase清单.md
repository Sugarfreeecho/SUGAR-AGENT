...
- 版本：2026-09-17 v3（覆盖至：`4083cbc` + 审批卡锚点修复）
- 用途：逐条审查（四字段格式）。
...
- 卡片锚点与流恢复稳定性（刷新/重连/恢复后卡片归属哪条工具行）见 09《[审批卡片锚点与流恢复稳定性](09-审批卡片锚点与流恢复稳定性方案设计-UseCase清单.md)》。
...
- 2026-09-17 v3：卡片锚点恢复单独成篇（09，UC-5I1~5I5）；本文保留卡片自身的呈现与决议流程用例。
